    ...
    <footer className="bg-black text-white py-16" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          <nav aria-labelledby="footer-support">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/account/addresses/new" className="text-sm font-bold hover:text-gray-300 transition-colors">Address</Link></li>
            </ul>
          </nav>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <Link href="/" className="text-2xl font-black tracking-tighter">SPIROM</Link>
