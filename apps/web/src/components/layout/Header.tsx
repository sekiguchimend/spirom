      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[100] bg-black text-brand-cream flex flex-col">
          <div className="p-6 md:p-8 flex justify-end">
             <button
              type="button"
              className="w-12 h-12 flex items-center justify-center text-brand-cream hover:text-white"
          ...
          <nav className="flex-1 flex flex-col justify-center items-center">
            <ul className="space-y-6 text-center">
              <li><Link href="/" className="text-4xl md:text-6xl font-black uppercase tracking-tighter hover:text-brand-green transition-colors" onClick={() => setIsMenuOpen(false)}>Home</Link></li>
              <li><Link href="/products" className="text-4xl md:text-6xl font-black uppercase tracking-tighter hover:text-brand-green transition-colors" onClick={() => setIsMenuOpen(false)}>Shop</Link></li>
              <li><Link href="/blog" className="text-4xl md:text-6xl font-black uppercase tracking-tighter hover:text-brand-green transition-colors" onClick={() => setIsMenuOpen(false)}>Blog</Link></li>
              <li><Link href="/about" className="text-4xl md:text-6xl font-black uppercase tracking-tighter hover:text-brand-green transition-colors" onClick={() => setIsMenuOpen(false)}>About</Link></li>
            </ul>
          </nav>
        </div>
      )}
