...
const faqs: FAQCategory[] = [
  ...
  },
  {
    ...
    color: '#00d4ff',
    items: [
      { question: '送料はいくらですか？', answer: '全国一律550円（税込）です。5,000円以上のご購入で送料無料となります。' },
      { question: '届くまでどのくらいかかりますか？', answer: 'ご注文確定後、1〜3営業日以内に発送いたします。お届けは発送日から1〜3日程度です。' },
      { question: '配送日時の指定はできますか？', answer: 'はい、ご注文時に配送日時をご指定いただけます。時間帯は午前中・14-16時・16-18時・18-20時・19-21時からお選びいただけます。' },
